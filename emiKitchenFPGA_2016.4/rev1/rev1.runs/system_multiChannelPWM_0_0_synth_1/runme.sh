...
HD_PWD='E:/datafiles/emilia/kitchen/modification/rev1/rev1.runs/system_multiChannelPWM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_multiChannelPWM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_multiChannelPWM_0_0.tcl
