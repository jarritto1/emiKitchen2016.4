...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../rev1.srcs/sources_1/bd/system/ipshared/100a" \
       +incdir+"$ref_dir/../../../../rev1.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../rev1.srcs/sources_1/bd/system/ipshared/100a" \
       +incdir+"../../../../rev1.srcs/sources_1/bd/system/ipshared/7e3a/hdl"
}
